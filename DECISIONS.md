...
2026-09-14 | BSIA Semiconductor Testing Engineering added (163rd): CS `6. BSIA_Semiconductor Testing Engineering_31 Aug 26.pdf`, 21 items Σw 161, weights by analogy with the other 5 BSIA sheets (CS carries none); approved 31 Aug 2026 from the filename (cover page says 01 September 2026) | user supplied the CS
