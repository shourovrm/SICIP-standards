...
2026-08-31 | BP chart labels: org (bold) + course on 2 lines when org has several courses in a group (clab/lab_svg); label 16px, sub 12px; course cut 27 report / 24 slides | user picked mockup D; 17px one-line labels overflowed
